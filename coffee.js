...
const coffeeSentence = `"${size} ${bean} ${style} is ready for ${customer.firstName} ${customer.lastName} !!"`

console.log(coffeeSentence)
...
completedOrders.innerHTML += coffeeSentence
